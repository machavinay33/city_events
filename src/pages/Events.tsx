      ...
      <Section>
        {events.length === 0 ? (
          <div className="rounded-3xl border-2 border-dashed border-ink/30 p-16 text-center">
            <p className="font-display text-2xl text-ink mb-2">Nothing on the calendar right now</p>
            <p className="text-ink/60">Follow us on Instagram to hear about the next one first.</p>
          </div>
        ) : (
