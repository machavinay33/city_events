...
function StatBlock({ label, value }: { label: string; value: number }) {
  ...
  return (
    <div ref={ref} className="text-center">
      <p className="font-display text-4xl sm:text-5xl text-chili">{current.toLocaleString('en-IN')}+</p>
...
export function Stats() {
  ...
  return (
    <section className="py-14 border-y-2 border-ink bg-gold-50">
      <div className="container-ce grid grid-cols-2 lg:grid-cols-4 gap-8">
        {home.stats.map((stat) => (
